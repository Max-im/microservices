...
app.post('/posts/:id/comments', async (req, res) => {
    ...
    await axios.post('http://localhost:5005/events', {event: {type: 'commentCreated', data: comment}});
...
app.post('/events', async (req, res) => {
    ...
    if (type === 'commentModerated') {
        ...
        await axios.post('http://localhost:5005/events', {event: {type: 'commentUpdated', data: comment }});
